    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <p className="menu-trigger flex items-center gap-2 rounded-full bg-[#A87133] px-3 py-2 text-white transition ease-in-out md:gap-3 md:px-4 md:py-2 max-sm:text-sm font-raleway cursor-pointer">
                    Plan My Trip
                </p>
            </DialogTrigger>

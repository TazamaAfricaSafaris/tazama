            ...
            <section className="bg-lighter relative bg-cover bg-center py-28">
                ...
                <div className="max-w-5xl z-10 relative top-0 left-0 w-full mx-auto flex flex-col items-center justify-center p-4 gap-8 md:p-10 xl:px-36 text-white">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full">
                        <Link href="/safaris" className="border border-primary bg-primary rounded-full px-4 lg:px-6 py-2 md:text-lg text-xl font-raleway text-white transition-colors duration-200 cursor-pointer">Explore More</Link>

                        <Dialog>
                            <DialogTrigger asChild>
                                <p className="border border-white hover:border-primary rounded-full px-4 lg:px-6 py-2 md:text-lg text-xl font-raleway text-white hover:bg-primary/15 transition-colors duration-200 cursor-pointer">
                                    Plan My Trip
                                </p>
                            </DialogTrigger>

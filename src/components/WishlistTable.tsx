      ...
      <table className="min-w-full border-collapse block md:table">
        <thead className="block md:table-header-group">
          <tr className="border border-dark/40 md:table-row font-raleway">
            ...
            <th className="block md:table-cell bg-primary text-white px-2 py-4 text-left font-semibold border border-dark/40">
              For Children
            </th>
          </tr>
        </thead>
        <tbody className="block md:table-row-group font-raleway">
          ...
          <tr className="border border-dark/40 md:table-row">
            ...
            <td className="block md:table-cell p-2 border border-dark/40">
              <Link
                className='underline'
                href='https://drbrownsbaby.com/products/dr-browns-specialty-feeding-system-8oz-240ml-2-pack'
              >
          ...
          <tr className="border border-dark/40 md:table-row">
            ...
            <td className="block md:table-cell p-2 border border-dark/40">
              <Link
                className='underline'
                href='http://www.tomatomnc.com/castnsplint/'
              >

            ...
            <div className='max-w-5xl mx-auto my-20'>
                ...
                <div className='flex flex-col md:flex-row gap-8 mt-16'>
                    <div className="w-full">
                        <h4 className='text-4xl text-dark mb-4'>Our Approach</h4>
                        ...
                        <br /><br />
                        <h4 className='text-4xl text-dark mb-4'>Experiential Learning in National Parks</h4>
                        <p>
                ...
                <div className='mt-16'>
                    <h4 className='text-4xl text-dark mb-4'>Addressing Domestic Tourism and Accessibility</h4>
                    <p>
                ...
                <div className='flex flex-col md:flex-row-reverse gap-8 mt-16'>
                    <div className="w-full">
                        <h4 className='text-4xl text-dark mb-4'>Focus on Local Youth</h4>
                        ...
                        <br /><br />
                        <h4 className='text-4xl text-dark mb-4'>Supporting Underprivileged Youth</h4>
                        <p>
                ...
                <div className='mt-16'>
                    <h4 className='text-4xl text-dark mb-4'>Giving Back and Moving Forward</h4>
                    <p>

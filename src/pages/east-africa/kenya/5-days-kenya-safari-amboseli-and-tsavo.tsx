...
const Page = () => {
    return (
        <>
            <HeadSEO title='5 Days Kenya Safari – Amboseli and Tsavo' keywords='' />
            ...
            <div className='mb-20 mt-28 max-w-5xl mx-auto md:px-8 px-4'>
                ...
                <section className='mt-20'>
                    <h3 className="text-center text-4xl  tracking-wider text-[#A87133]">
                        Detailed Itinerary for 5 Days Kenya Safari – Amboseli and Tsavo
                    </h3>
                            ...
                            {fiveDaysTemboSafariAmboseliandTsavo.map((item, index) => (
                                <div key={index}>
                                    <ItineraryAccordion
                                        ...
                                        totalDays={fiveDaysTemboSafariAmboseliandTsavo.length}
                                        tripType='safari'
                                    />
                                </div>
                            ))}
